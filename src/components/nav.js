...
const Nav = () => {
  return (
    <nav className="db dt-l w-100 border-box pa3 ph5-l bg-dark-gray">
      <a className="db dtc-l v-mid mid-gray link dim w-100 w-25-l tc tl-l mb2 mb0-l" href="/settings" title="Home">
