...
const SkillCard = (props) => {
  const EditButton = props.editMode === true ? <Link to={`/skilledit/${props.index}`}>{({href}) => <a className='f6 link dim br1 ba ph3 pv2 mb2 dib black' href={href}>Edit</a>}</Link> : null
